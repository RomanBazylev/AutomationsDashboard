...
CHANNELS = [
    ...
    },
    {
        ...
        "workflows": ["generate_salesforce_short.yml", "generate_salesforce_long.yml"],
        "schedules": {"generate_salesforce_short.yml": "every 4h", "generate_salesforce_long.yml": "daily 08:00"},
        "perf_log_path": "performance_log.json",
        "youtube_url": "",
    },
    {
